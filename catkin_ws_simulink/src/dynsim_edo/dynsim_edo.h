...
typedef struct {
  ...
  ros_slros_internal_block_GetP_T obj_n4;// '<S13>/Get Parameter6'
  ros_slros_internal_block_GetP_T obj_f;// '<S13>/Get Parameter7'
  ros_slros_internal_block_GetP_T obj_d;// '<S13>/Get Parameter8'
  ...
  ros_slros_internal_block_GetP_T obj_o;// '<S13>/Get Parameter9'
  ros_slros_internal_block_GetP_T obj_d5;// '<S13>/Get Parameter10'
  ros_slros_internal_block_GetP_T obj_l;// '<S13>/Get Parameter11'
  ros_slros_internal_block_Publ_T obj_a;// '<S10>/SinkBlock'
  ros_slros_internal_block_Publ_T obj_f2;// '<S9>/SinkBlock'
...
//
//  '<Root>' : 'dynsim_edo'
//  '<S1>'   : 'dynsim_edo/2link_planar robot dynamic model'
//  '<S2>'   : 'dynsim_edo/Assign to CartesianState msg'
//  '<S3>'   : 'dynsim_edo/Assign to JointState msg'
//  '<S4>'   : 'dynsim_edo/Assign to Time msg'
//  '<S5>'   : 'dynsim_edo/Blank Message'
//  '<S6>'   : 'dynsim_edo/Blank Message1'
//  '<S7>'   : 'dynsim_edo/MATLAB Function'
//  '<S8>'   : 'dynsim_edo/Publish'
//  '<S9>'   : 'dynsim_edo/Publish1'
//  '<S10>'  : 'dynsim_edo/Publish2'
//  '<S11>'  : 'dynsim_edo/Subscribe'
//  '<S12>'  : 'dynsim_edo/2link_planar robot dynamic model/Forward Dynamics'
//  '<S13>'  : 'dynsim_edo/2link_planar robot dynamic model/Subsystem'
