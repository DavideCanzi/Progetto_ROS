...
// C/C++ source code generated on : Mon May 18 14:52:43 2020
//
...
void kinsim_edo_step(void)
{
  ...
  ParamGet_kinsim_edo_81.get_parameter(&kinsim_edo_B.value_c);

  // MATLABSystem: '<S11>/Get Parameter3'
  ParamGet_kinsim_edo_82.get_parameter(&kinsim_edo_B.value_k);

  // MATLABSystem: '<S11>/Get Parameter4'
  ParamGet_kinsim_edo_83.get_parameter(&kinsim_edo_B.value_cx);

  // MATLABSystem: '<S11>/Get Parameter5'
  ParamGet_kinsim_edo_84.get_parameter(&kinsim_edo_B.value_b);
  ...
  kinsim_edo_B.d5 = kinsim_edo_B.value_cx + kinsim_edo_X.Integrator_CSTATE[2];
  kinsim_edo_B.d1 = cos(kinsim_edo_B.d5);
  kinsim_edo_B.d6 = kinsim_edo_B.d5 + kinsim_edo_X.Integrator_CSTATE[3];
  kinsim_edo_B.d2 = cos(kinsim_edo_B.d6);
  kinsim_edo_B.d7 = kinsim_edo_B.d6 + kinsim_edo_X.Integrator_CSTATE[4];
  kinsim_edo_B.d3 = cos(kinsim_edo_B.d7);
  kinsim_edo_B.d8 = kinsim_edo_B.d7 + kinsim_edo_X.Integrator_CSTATE[5];
  kinsim_edo_B.d4 = cos(kinsim_edo_B.d8);
  ...
  kinsim_edo_B.msg_d.Position[0] = ((((kinsim_edo_P.Constant_Value_m[0] *
    ...
    kinsim_edo_B.value_b) + kinsim_edo_P.Constant_Value_m[2] * kinsim_edo_B.d1)
    + kinsim_edo_P.Constant_Value_m[3] * kinsim_edo_B.d2) +
    kinsim_edo_P.Constant_Value_m[4] * kinsim_edo_B.d3) +
    kinsim_edo_P.Constant_Value_m[5] * kinsim_edo_B.d4;
  ...
  kinsim_edo_B.d5 = sin(kinsim_edo_B.d5);
  kinsim_edo_B.d6 = sin(kinsim_edo_B.d6);
  kinsim_edo_B.d7 = sin(kinsim_edo_B.d7);
  kinsim_edo_B.d8 = sin(kinsim_edo_B.d8);
  kinsim_edo_B.d9 = kinsim_edo_B.In1.Velocities[0] +
    kinsim_edo_B.In1.Velocities[1];
  kinsim_edo_B.d10 = kinsim_edo_B.d9 + kinsim_edo_B.In1.Velocities[2];
  kinsim_edo_B.d11 = kinsim_edo_B.d10 + kinsim_edo_B.In1.Velocities[3];
  kinsim_edo_B.d12 = kinsim_edo_B.d11 + kinsim_edo_B.In1.Velocities[4];
  kinsim_edo_B.d9 *= kinsim_edo_P.Constant_Value_m[1];
  kinsim_edo_B.d10 *= kinsim_edo_P.Constant_Value_m[2];
  kinsim_edo_B.d11 *= kinsim_edo_P.Constant_Value_m[3];
  kinsim_edo_B.d13 = kinsim_edo_B.d12 * kinsim_edo_P.Constant_Value_m[4];
  kinsim_edo_B.d12 = (kinsim_edo_B.d12 + kinsim_edo_B.In1.Velocities[5]) *
    kinsim_edo_P.Constant_Value_m[5];
  ...
  kinsim_edo_B.msg_d.Velocity[0] = ((((-kinsim_edo_P.Constant_Value_m[0] *
    kinsim_edo_B.In1.Velocities[0] * kinsim_edo_B.d - kinsim_edo_B.d9 *
    kinsim_edo_B.value_cx) - kinsim_edo_B.d10 * kinsim_edo_B.d5) -
    kinsim_edo_B.d11 * kinsim_edo_B.d6) - kinsim_edo_B.d13 * kinsim_edo_B.d7) -
    kinsim_edo_B.d12 * kinsim_edo_B.d8;
  for (i = 0; i < 7; i++) {
  ...
  kinsim_edo_B.msg_d.Position[1] = ((((kinsim_edo_P.Constant_Value_m[0] *
    ...
    kinsim_edo_P.Constant_Value_m[2] * kinsim_edo_B.d5) +
    kinsim_edo_P.Constant_Value_m[3] * kinsim_edo_B.d6) +
    kinsim_edo_P.Constant_Value_m[4] * kinsim_edo_B.d7) +
    kinsim_edo_P.Constant_Value_m[5] * kinsim_edo_B.d8;
  kinsim_edo_B.msg_d.Velocity[1] = ((((kinsim_edo_B.d9 * kinsim_edo_B.value_b +
    kinsim_edo_P.Constant_Value_m[0] * kinsim_edo_B.In1.Velocities[0] *
    kinsim_edo_B.value_k) + kinsim_edo_B.d10 * kinsim_edo_B.d1) +
    kinsim_edo_B.d11 * kinsim_edo_B.d2) + kinsim_edo_B.d13 * kinsim_edo_B.d3) +
    kinsim_edo_B.d12 * kinsim_edo_B.d4;
...
void kinsim_edo_initialize(void)
{
...

  {
    ...
    ParamGet_kinsim_edo_65.set_initial_value(1.570796327);
    ...
    ParamGet_kinsim_edo_81.set_initial_value(0.0);
    ...
    ParamGet_kinsim_edo_82.set_initial_value(0.0);
    ...
    ParamGet_kinsim_edo_83.set_initial_value(0.0);
    ...
    ParamGet_kinsim_edo_84.set_initial_value(0.0);
